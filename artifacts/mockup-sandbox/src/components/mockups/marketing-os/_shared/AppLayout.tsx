...
const NAV: { key: NavKey; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { key: "brand", label: "Brand Memory", icon: BookMarked },
];
        ...
        <div className="px-3 pb-4">
          ...
          >
            ...
            <div className="relative">
              ...
              <button className="mt-2.5 w-full rounded-lg bg-white/15 py-1.5 text-[12px] font-semibold backdrop-blur transition-colors hover:bg-white/25">
                Open assistant
              </button>
            </div>
          </div>
